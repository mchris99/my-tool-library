...
* Resources and partner links. Each tool can carry two lists of outward links: resources for using it (the manual, a safety video, a how-to) and partner links for supplying it (the local shops that stock its blades, belts or fuel). Add them on the Inventory page as name/link boxes, or hit Edit JSON to paste a whole list at once. Both show as collapsed sections wherever a tool's details appear — the Inventory page, the public catalog, and a member's own reservations — and open in a new tab.
